...
class GraphInterface
{
    ...
    private :
        ...
        grman::WidgetBox m_tool_sauve;
        grman::WidgetBox m_label_sauve;
        ///boutons rajoutés (visuel only)
        grman::WidgetButton ajout_sommet;       ///bouton ajout sommets
        grman::WidgetButton ajout_arc;          ///bouton ajout arc
        grman::WidgetButton sauvegarde;         ///bouton sauvegarde
        grman::WidgetButton del_arc;            ///bouton suppression arete
        grman::WidgetButton del_som;            ///bouton suppression sommet
...
class Graph
{
    ...
    public:
        ...
        void chargement(std::string NomFichier);
        void creerGraph();
        void ajouterSommet(std::string NomFichier, int sommet_indic);
        void ajouterArc(std::string NomFichier, int arc_indic);
        void test_remove_edge(int eidx);

        /// La méthode update à appeler dans la boucle de jeu pour les graphes avec interface
        void update(Graph g, int q, int Si, int Ai, int eidx);
};
